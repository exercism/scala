...
class PythagoreanTripletTest extends AnyFunSuite with Matchers {
  test("isPythagorean") {
    ...
    PythagoreanTriplet.isPythagorean((3, 5, 4)) should be (false)
    PythagoreanTriplet.isPythagorean((4, 3, 5)) should be (false)
    PythagoreanTriplet.isPythagorean((4, 5, 3)) should be (false)
    PythagoreanTriplet.isPythagorean((5, 3, 4)) should be (false)
    PythagoreanTriplet.isPythagorean((5, 4, 3)) should be (false)

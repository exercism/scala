...
class RobotNameTest extends AnyFunSpec with Matchers {
  ...
  // There are 26* 26 * 900 = 608,400 possible robot names - you have to ensure that none are repeated.
  // The Robot code needs to be efficient enough to allow all 608,400 unique names to be generated.
  ignore("a large number of new instances have unique names") {
    val alreadySet = mutable.HashSet.empty[String]
    for(_ <- 0 until 608400 - 6) { // as 6 robot names are generated in the tests above!!
